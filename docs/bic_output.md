...
- `<ALIGNER>/alignment_metrics/samtools_stats/`
...
- `<ALIGNER>/metrics/picard_metrics/`
...
- `<ALIGNER>/metrics/stringtie/<SAMPLE>.ballgown/`: Ballgown output directory.
...
- `<ALIGNER>/alignment_metrics/rseqc/infer_experiment/`
...
- `<ALIGNER>/alignment_metrics/rseqc/read_distribution/`
...
- `<ALIGNER>/alignment_metrics/rseqc/inner_distance/pdf/`
  - `*.inner_distance_plot.pdf`: PDF file containing inner distance plot.
- `<ALIGNER>/alignment_metrics/rseqc/inner_distance/rscript/`
  - `*.inner_distance_plot.r`: R script used to generate pdf plot above.
- `<ALIGNER>/alignment_metrics/rseqc/inner_distance/txt/`
...
- `<ALIGNER>/alignment_metrics/rseqc/junction_saturation/pdf/`
  - `*.junctionSaturation_plot.pdf`: PDF file containing junction saturation plot.
- `<ALIGNER>/alignment_metrics/rseqc/junction_saturation/rscript/`
...
- `<ALIGNER>/alignment_metrics/rseqc/read_duplication/pdf/`
  - `*.DupRate_plot.pdf`: PDF file containing read duplication plot.
- `<ALIGNER>/alignment_metrics/rseqc/read_duplication/rscript/`
  - `*.DupRate_plot.r`: R script used to generate pdf plot above.
- `<ALIGNER>/alignment_metrics/rseqc/read_duplication/xls/`
...
- `<ALIGNER>/alignment_metrics/rseqc/bam_stat/`
...
- `<ALIGNER>/alignment_metrics/rseqc/tin/`
...
- `<ALIGNER>/alignment_metrics/qualimap/<SAMPLE>/`
